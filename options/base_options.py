...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='unaligned_triplet',
                                 help='chooses how datasets are loaded. [unaligned | aligned | single]')
        self.parser.add_argument('--model', type=str, default='recycle_gan',
    ...
    def parse(self):
        ...
        # set gpu ids
        # if torch.cuda.is_available() and len(self.opt.gpu_ids) > 1:
